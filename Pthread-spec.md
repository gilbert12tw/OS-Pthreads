...
- Your code should be placed in repository `os<year>_team<team-id>_pthread`, else you will get 0 points on this part.
...
- Name your report `pthread-report.md` and upload it to repo.
